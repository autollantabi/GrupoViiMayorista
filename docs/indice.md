...
| [apis.md](apis.md) | Instancias HTTP (api principal y apiShell), URLs y variables de entorno, cabeceras, servicios que usan cada API, endpoints representativos, riesgos o dependencias. | Integrar o modificar llamadas al backend; depurar problemas de autenticación o de API; documentar nuevos endpoints. |
