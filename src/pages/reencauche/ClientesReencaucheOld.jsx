...
import FormularioNuevoClienteOld from "./FormularioNuevoClienteOld";
import FormularioNuevoBonoListaOld from "./FormularioNuevoBonoListaOld";
...
const ClientesReencaucheOld = () => {
  ...
  return (
    <>
      ...
      />
      <PageContainer
        backButtonOnClick={() => navigate(ROUTES.ECOMMERCE.REENCAUCHE)}
        backButtonText="Volver al listado por Master"
      >
        <PageHeader>
          <PageTitle>
...
export default ClientesReencaucheOld;
