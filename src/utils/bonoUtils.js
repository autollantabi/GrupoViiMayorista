...
/**
 * Genera el PDF con múltiples bonos y lo envía por email/WhatsApp al cliente.
 * Usado por el flujo clásico de bonos con cliente final (FormularioNuevoBonoListaOld).
 */
